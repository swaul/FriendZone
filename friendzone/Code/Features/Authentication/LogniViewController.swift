...
internal struct RectFramer {
    ...
    let origin, bottomRight, topRight, bottomLeft, topMid, topLeft, rightMid: CGPoint
    ...
    internal init(withView view: UIView) {
        ...
        rightMid = CGPoint(x: maxX, y: midY - midY / 2)
    }
...
//        bezPathStage1.addLine(to: rectRef.rightMid)
        ...
        bezPathStage1.addQuadCurve(to: rectRef.bottomRight, controlPoint: CGPoint(x: rectRef.midX, y: rectRef.midY - rectRef.midY / 2))
//        bezPathStage2.addLine(to: rectRef.rightMid)
        ...
        bezPathStage1.addQuadCurve(to: rectRef.bottomRight, controlPoint: CGPoint(x: rectRef.midX - rectRef.midX / 2, y: rectRef.midY - rectRef.midY / 2))
//        bezPathStage3.addLine(to: rectRef.rightMid)
        bezPathStage3.close()
        ...
        bezPathStage5.addLine(to: rectRef.topMid)
        bezPathStage5.addLine(to: rectRef.bottomRight)
        bezPathStage5.close()
        
        let bezPathStage6: UIBezierPath = UIBezierPath()
        bezPathStage6.move(to: rectRef.topRight)
        bezPathStage6.addLine(to: rectRef.topMid)
        bezPathStage6.addLine(to: rectRef.bottomRight)
        bezPathStage6.close()
        
        let bezPathStage7: UIBezierPath = UIBezierPath()
        bezPathStage7.move(to: rectRef.topRight)
        bezPathStage7.addLine(to: rectRef.topMid)
        bezPathStage7.addLine(to: rectRef.bottomRight)
        bezPathStage7.close()
//        let bezPathStage1: UIBezierPath = UIBezierPath()
//        bezPathStage1.move(to: rectRef.bottomLeft)
//        bezPathStage1.addLine(to: rectRef.bottomRight)
//        bezPathStage1.addLine(to: rectRef.topRight) // A Current point
//        bezPathStage1.addQuadCurve(to: rectRef.topLeft, // C End point
//                                   controlPoint: CGPoint(x: rectRef.minX, y: rectRef.minY)) // B Control point, top left corner
//        bezPathStage1.close()
//
//        let bezPathStage2: UIBezierPath = UIBezierPath()
//        bezPathStage2.move(to: rectRef.bottomLeft)
//        bezPathStage2.addLine(to: rectRef.bottomRight)
//        bezPathStage2.addLine(to: rectRef.topRight) // A Current point
//        bezPathStage2.addQuadCurve(to: rectRef.topLeft,  // C End point
//                                   controlPoint: CGPoint(x: rectRef.midX, y: rectRef.minY - (rectRef.viewRef.frame.size.height / 2.0))) // B Control point, top-middle
//        bezPathStage2.close()
//
//        let bezPathStage3: UIBezierPath = UIBezierPath()
//        bezPathStage3.move(to: rectRef.bottomLeft)
//        bezPathStage3.addLine(to: rectRef.bottomRight)
//        bezPathStage3.addLine(to: rectRef.topRight) // A Current point
//        bezPathStage3.addQuadCurve(to: rectRef.topLeft, // C End point
//                                   controlPoint: CGPoint(x: rectRef.maxX, y: rectRef.minY)) // B Control point, top right corner
//        bezPathStage3.close()
...
//        // wave trough anims
//        let bezPathStage5: UIBezierPath = UIBezierPath()
//        bezPathStage5.move(to: rectRef.bottomLeft)
//        bezPathStage5.addLine(to: rectRef.bottomRight)
//        bezPathStage5.addLine(to: rectRef.topRight)
//        bezPathStage5.addQuadCurve(to: rectRef.topLeft, controlPoint: CGPoint(x: rectRef.maxX, y: rectRef.maxY)) // bottom right control point
//        bezPathStage5.close()
//
//        let bezPathStage6: UIBezierPath = UIBezierPath()
//        bezPathStage6.move(to: rectRef.bottomLeft)
//        bezPathStage6.addLine(to: rectRef.bottomRight)
//        bezPathStage6.addLine(to: rectRef.topRight)
//        bezPathStage6.addQuadCurve(to: rectRef.topLeft, controlPoint: CGPoint(x: rectRef.midX, y: rectRef.maxY + (rectRef.viewRef.frame.size.height / 2.0))) // bottom right control point
//        bezPathStage6.close()
//
//        let bezPathStage7: UIBezierPath = UIBezierPath()
//        bezPathStage7.move(to: rectRef.bottomLeft)
//        bezPathStage7.addLine(to: rectRef.bottomRight)
//        bezPathStage7.addLine(to: rectRef.topRight)
//        bezPathStage7.addQuadCurve(to: rectRef.topLeft, controlPoint: CGPoint(x: rectRef.minX, y: rectRef.maxY)) // bottom right control point
//        bezPathStage7.close()
